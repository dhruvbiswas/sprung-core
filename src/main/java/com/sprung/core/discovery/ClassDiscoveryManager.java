...
import com.sprung.core.utils.StringUtils;
...
public class ClassDiscoveryManager {
    ...
    public static List<String> discover(String packageName) throws IOException {
        ...
        String classpath = System.getProperty(Constants.SPRUNG_CLASSPATH_SYSTEM_PROPERTY);
        String[] paths = classpath.split(System.getProperty(Constants.SPRUNG_FILE_SEPARATOR_SYSTEM_PROPERTY));
